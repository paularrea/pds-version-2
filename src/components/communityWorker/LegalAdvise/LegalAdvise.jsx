...
const LegalAdvise = () => {
  const handleAccept = () => {
    console.log("accept legal adivse");
  };
  ...
  return (
    <div className={container}>
      ...
      <p>
        ...
        utilice y monitoree mi localización geográfica al utilizar la aplicación
        de Protectores de Salud conforme a lo establecido en la política y
        notificación expresa sobre los requisitos y los procedimientos de la
        utilización de la aplicación de Protectores de Salud de NHS. Entiendo
        que cualquier incumplimiento con el Plan o violación a las Normas de NHS
        es una razón para una acción disciplinaria, que hasta podría incluir la
        terminación del empleo.
      </p>
      <Button bgColor="#00CB45" onClick={handleAccept}>
        Aceptar
      </Button>
    </div>
  );
