...
const subtype_PATIENT_VALIDATION_OF_INTERVENTION = (userId, geoCoords, patientValidationSignature) => {
  const template_obj = build_event_template();
  const event_obj = {
    event_created_by_user_id: userId,
    event_type: "LEGAL",
    event_subtype: "PATIENT_VALIDATION_OF_INTERVENTION",
    device_geolocation_coords: geoCoords,
    content: {
      legal_document_id: "f9c273d1-0cb4-4a00-92a5-5549b4c99d31",
      signature: patientValidationSignature,
    },
  };
...
export default subtype_PATIENT_VALIDATION_OF_INTERVENTION;
